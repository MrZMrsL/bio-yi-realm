<template>
  <div class="title-display-overlay" v-if="visible" @click.self="close">
    <div class="title-display-panel" :class="{ 'title-enter': animating }">
      ...
      <!-- 成就列表 -->
      <div class="title-achievements-section" v-if="titleInfo.achievements && titleInfo.achievements.length > 0">
      ...
      <!-- 关闭按钮 -->
      <button class="title-close-btn" @click="close">继续冒险 →</button>
    </div>
  </div>
</template>
