<template>
  <div class="skill-tree-panel">
    ...
    <!-- 无技能提示 -->
    <div v-if="!specData?.skills?.length" class="no-skills">
      当前专精暂无技能数据
    </div>
  </div>
</template>
...
@keyframes pulse-milestone {
  0%, 100% { border-color: rgba(212, 168, 83, 0.25); }
...
.unlocked-icon { color: #2ecc71; font-weight: bold; }
.pending-icon { color: #d4a853; }
.locked-icon { color: #666; }
