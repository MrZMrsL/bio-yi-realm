...
export const ACHIEVEMENTS = [
  ...
  },
  {
    ...
    progress: () => (stats.value.subjectCorrect || {}).chem || 0,
    maxProgress: 200,
    reward: { exp: 150 }
  },
  {
    ...
    progress: () => (stats.value.subjectCorrect || {}).bio || 0,
    maxProgress: 200,
    reward: { exp: 150 }
  },
  {
    ...
    progress: () => (stats.value.subjectCorrect || {}).yi || 0,
    maxProgress: 200,
    reward: { exp: 150 }
  },
 ...
 * @param {Object} state 游戏状态 { stats, farm, level, allClearCount, cyclopedia }
 * @returns {boolean} 是否已解锁
 */
export function checkAchievementUnlocked(achievement, state) {
  const { stats, farm, level, allClearCount, cyclopedia } = state
