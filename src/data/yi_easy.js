...
export const YI_EASY = [
  ...
  // ===== 2026年增补（10题）=====
  { q: "五行中，'金'对应的季节是（ ）", options: ["A. 春", "B. 夏", "C. 秋", "D. 冬"], answer: 2, diff: "easy", subject: "yi", explain: "五行对应季节：木春（生发）、火夏（炎热）、土季夏/长夏（转化）、金秋（肃杀）、水冬（收藏）。" },
  { q: "五行中，'水'对应的颜色是（ ）", options: ["A. 红", "B. 白", "C. 黑", "D. 黄"], answer: 2, diff: "easy", subject: "yi", explain: "五行五色：木青（绿）、火红、土黄、金白、水黑。黑色代表水的颜色（深渊之色）。" },
  { q: "十二地支中，'未'对应的生肖是（ ）", options: ["A. 马", "B. 羊", "C. 猴", "D. 鸡"], answer: 1, diff: "easy", subject: "yi", explain: "子鼠丑牛寅虎卯兔辰龙巳蛇午马未羊申猴酉鸡戌狗亥猪。未对应羊。" },
  { q: "十二地支中，'申'对应的生肖是（ ）", options: ["A. 羊", "B. 猴", "C. 鸡", "D. 狗"], answer: 1, diff: "easy", subject: "yi", explain: "子鼠丑牛寅虎卯兔辰龙巳蛇午马未羊申猴酉鸡戌狗亥猪。申对应猴。" },
  { q: "河图数中，'水'对应的数是（ ）", options: ["A. 一和六", "B. 二和七", "C. 三和八", "D. 四和九"], answer: 0, diff: "easy", subject: "yi", explain: "河图生数成数：水一六、火二七、木三八、金四九、土五十。天一生水，地六成之。" },
  { q: "河图数中，'火'对应的数是（ ）", options: ["A. 一和六", "B. 二和七", "C. 三和八", "D. 四和九"], answer: 1, diff: "easy", subject: "yi", explain: "河图：水一六、火二七、木三八、金四九、土五十。地二生火，天七成之。" },
  { q: "易经六十四卦中，第一卦是（ ）", options: ["A. 坤卦", "B. 乾卦", "C. 屯卦", "D. 泰卦"], answer: 1, diff: "easy", subject: "yi", explain: "《周易》上经第一卦为乾䷀（乾为天），第二卦为坤䷁（坤为地）。乾卦六爻皆阳，象征天、创造。" },
  { q: "地支相合中，'子丑相合'化解为（ ）", options: ["A. 土", "B. 水", "C. 木", "D. 火"], answer: 0, diff: "easy", subject: "yi", explain: "地支六合：子丑合土、寅亥合木、卯戌合火、辰酉合金、巳申合水、午未合土。子丑合化土。" },
  { q: "地支相冲中，'子午相冲'的五行关系是（ ）", options: ["A. 木与金", "B. 水与火", "C. 土与水", "D. 金与木"], answer: 1, diff: "easy", subject: "yi", explain: "地支六冲：子午冲（水克火）、丑未冲（土克土）、寅申冲（金克木）、卯酉冲（金克木）、辰戌冲（土克土）、巳亥冲（水克火）。子午冲是水与火相冲。" },
  { q: "六十四卦中，'否卦'的卦象是（ ）", options: ["A. 乾上坤下", "B. 坤上乾下", "C. 水在上火在下", "D. 火在上水在下"], answer: 0, diff: "easy", subject: "yi", explain: "否卦䷋是乾上坤下（天在上地在下），天地不交，万物不通，为否塞之象。泰卦䷊正好相反（坤上乾下），天地交泰。" },
];
